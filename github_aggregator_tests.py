...
# File Imports
from github_aggregator import gather_repos, gather_commits
...
class TestGitHubAggregator(unittest.TestCase):
    ...
    def test_gather_commits(self):
        self.assertEqual(gather_commits('kylerozanitis', 'Triangle567'), ('kylerozanitis', 11))
        self.assertNotEqual(gather_commits('kylerozanitis', 'Triangle567'), ('kylerozanitis', 13))
        self.assertEqual(gather_commits('Asupkay', 'Chirp'), ('Asupkay', 2))
