...
class TestGitHubAggregator(unittest.TestCase):
    ...
    def test_gather_github_info(self):
        self.assertEqual(gather_github_info('kylerozanitis'), [('DSA', 9), ('expressionevaluator', 6), ('gedcom-parser', 30), ('GitHubApi567', 15), ('hello-world', 3), ('Personal-Website', 11), ('school-data-management-system', 7), ('SSW-567', 9), ('Triangle567', 11)])
